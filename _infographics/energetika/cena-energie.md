...
- V prípade **uhoľných elektrární** graf uvádza priemer ceny pri použití technológie zachytávania uhlíka (cca 136 €/MWh) a bez jej použitia (cca 56 €/MWh, no k tejto cene treba pripočítať asi ešte 40 €/MWh za emisné povolenky). Cena emisnej povolenky odráža dodatočné náklady, ktoré spôsobuje takáto uhoľná elektráreň svojím dopadom na životné prostredie (tzv. negatívna externalita). Ako popisujeme v explaineri o [emisných povolenkách](/explainery/emisne-povolenky-ets), dá sa očakávať, že sa cena povoleniek bude s rastúcim tlakom na dekarbonizáciu energetiky a priemyslu naďalej zvyšovať, a výroba energie v týchto elektrárňach sa tak bude čoraz viac a viac predražovať. 
