---
layout:      explainer
title:       "Extrémy počasia a klimatická zmena. Ako o nich hovoriť a písať"
slug:        "prirucka-vplyv-klimy-na-extremy"
...
perex:       "S každým ďalším extrémnym prejavom počasia sa znova vynoria podobné otázky: Je dnes takých pohrôm viac ako kedysi? Sú silnejšie? A je to kvôli klimatickej zmene? Niekedy áno a niekedy nie. Zverejňujeme slovenský preklad <i>Kompasu pre novinárov</i>, publikácie dvoch renomovaných britských klimatológov, ktorej cieľom je urobiť v týchto otázkach jasno – stručne zhrnúť najnovšie vedecké poznatky a poskytnúť návod novinárom, ktorí o klimatickej zmene a extrémnych javoch informujú verejnosť."
---

_Tento text je webová verzia príručky [Kompas pre novinárov](https://www.worldweatherattribution.org/reporting-extreme-weather-and-climate-change-a-guide-for-journalists/) od iniciatívy World Weather Attribution, ktorú sme so súhlasom jej autorov preložili do češtiny a následne do slovenčiny._
{: .longread-small}

## Úvod
{% comment %}
{% include preview-box.html
    title="Jednostranové zhrnutie"
    text="V infografike uvádzame to najdôležitejšie o vplyve klimatickej zmeny na jednotlivé extrémy počasia."
    slug="vplyv-klimy-na-extremy"
%}
{% endcomment %}
Klimatická zmena spôsobená človekom vedie k tomu, že extrémne meteorologické javy ako vlny horúčav, silné dažde, búrky a či naopak obdobia sucha, sú v mnohých oblastiach sveta čoraz častejšie a intenzívnejšie. To však neznamená, že sa zvyšuje pravdepodobnosť výskytu *všetkých* extrémnych udalostí a navyše, zmeny sa v niektorých častiach sveta prejavujú viac a v iných menej. V každom prípade majú tieto udalosti často významné dopady na spoločnosť: strata úrody či poľnohospodárskej pôdy, zničenie majetku, vážne narušenie ekonomiky, straty na životoch atď. Keď sa niečo také stane, verejnosť sa zvyčajne začne pýtať na príčiny. Čoraz častejšie sa kladie otázka: "Bola táto udalosť spôsobená zmenou klímy?"

Cieľom tejto publikácie je pomôcť novinárom zorientovať sa v tejto problematike. Text najprv predstavuje vedeckú metódu nazývanú "atribúcia extrémnych udalostí", pomocou ktorej možno určiť, do akej miery môžeme (alebo nemôžeme) prisúdiť, *atribuovať*, danú meteorologickú udalosť klimatickej zmene. Ďalej Kompas obsahuje aj spoľahlivé tvrdenia, ktoré sa dajú použiť na niektoré typy extrémnych prejavov počasia, ktoré aktuálne zaujímajú verejnosť, a to aj vtedy, keď na danú tému práve neprebieha žiadny konkrétny výskum. Tieto tvrdenia sú založené na najnovších správach <glossary id="ipcc">medzivládneho panelu IPCC</glossary> a na poznatkoch vychádzajúcich zo štúdií zameraných na nedávne extrémne udalosti. Záverečná kapitolka je stručným prehľadom všetkých extrémnych meteorologických udalostí a zhrnutie najdôležitejších posolstiev, ktoré treba pri každej z nich komunikovať.

Médiá a spravodajské agentúry sa pri informovaní o extrémnych meteorologických javoch často dopúšťajú troch chýb: ignorujú zmenu klímy ako príčinu udalosti, alebo udalosť pripisujú zmene klímy bez toho, aby toto tvrdenie podložili dôkazmi, alebo uvádzajú zmenu klímy ako jedinú príčinu extrémnej meteorologickej udalosti.

Čiastočne je to preto, že otázka, či bola nejaká udalosť spôsobená klimatickou zmenou, síce znie logicky, je v skutočnosti položená nesprávne. Ak napríklad silný fajčiar dostane rakovinu pľúc, nepovieme, že cigarety spôsobili jeho rakovinu – môžeme ale povedať, že v dôsledku fajčenia (resp. škôd spôsobenými cigaretami) je uňno vyššia pravdepodobnosť vzniku tohto ochorenia. Rovnako **klimatická zmena nemôže spôsobiť určitú extrémnu udalosť** (v zmysle "príčina" vedie k "následku"), pretože všetky meteorologické javy majú viacero príčin a svoju úlohu zohráva aj náhoda – počasie je do určitej miery chaotické.

Klimatická zmena **však môže ovplyvniť pravdepodobnosť aj intenzitu udalosti, a teda aj jej vplyv na ľudí, majetok a prírodu**. Novinári, ktorých úlohou je po katastrofe uspokojiť záujem verejnosti, preto musia vedieť, ako sa na nej zmena klímy podieľala. Pomocou atribúcie extrémnych udalostí im na to veda môže poskytnúť odpoveď.

Až donedávna sa vedci väčšinou vyhýbali spájaniu jednotlivých udalostí so zmenou klímy. Namiesto toho poukazovali na všeobecný trend a tvrdili, že daná udalosť môže byť niečím, čo budeme v budúcnosti zažívať častejšie. Klimatická zmena však významne ovplyvňuje počasie už desaťročia a vedci konečne začínajú o tejto súvislosti hovoriť viac. V posledných rokoch boli vyvinuté metódy, ktoré umožňujú zistiť prepojenie medzi extrémnymi udalosťami (javmi) a klimatickou zmenou a tiež vypočítať, ako veľmi sa zvýšila alebo znížila pravdepodobnosť výskytu udalosti alebo jej intenzita v dôsledku globálneho otepľovania.

Odpoveď je vždy iná – závisí od lokality, ročného obdobia, typu udalosti a tiež od jej intenzity, trvania a rozsahu. Nie všetky extrémne meteorologické javy sú v dôsledku zmeny klímy častejšie alebo horšie – pravdepodobnosť výskytu niektorých z nich môže byť nižšia alebo môže zostať viac-menej rovnaká. Určitá novinárska opatrnosť nehľadať súvislosti tam, kde nie sú, je preto oprávnená.
